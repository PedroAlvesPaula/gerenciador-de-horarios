...
const theme = createTheme({
  palette: {
    ...
    action: {
      disabled: "rgba(61, 48, 33, 0.4)",
      disabledBackground: "rgba(61, 48, 33, 0.12)",
    },
  },
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          padding: "8px 24px",
          "&.Mui-disabled": {
            backgroundColor: "rgba(61, 48, 33, 0.12)",
      ...
      styleOverrides: {
        root: {
          "&.Mui-disabled .MuiOutlinedInput-notchedOutline": {
            borderColor: "rgba(61, 48, 33, 0.15)",
          },
        },
      },
    },
